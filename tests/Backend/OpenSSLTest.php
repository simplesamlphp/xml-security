...
final class OpenSSLTest extends TestCase
{
    ...
    {
        $this->privKey = PrivateKey::fromFile('file://' . dirname(dirname(dirname(__FILE__))) . '/tests/resources/keys/privkey.pem');
        $this->pubKey = PublicKey::fromFile('file://' . dirname(dirname(dirname(__FILE__))) . '/tests/resources/keys/pubkey.pem');
